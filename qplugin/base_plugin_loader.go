...
func (me BasePluginLoader) RegisterThenStart(logger qlang.Logger, plugin Plugin) {
	me.Register(plugin)
...
func (me BasePluginLoader) Start(logger qlang.Logger) error {
	me.mutex.Lock()
	defer me.mutex.Unlock()
...
func (me BasePluginLoader) Stop(logger qlang.Logger) error {
	me.mutex.Lock()
	defer me.mutex.Unlock()
