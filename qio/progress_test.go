...
func TestProgressWriter(t *testing.T) {
	...
	pw := NewProgressWriter(&buf, int64(len(content)), onProgress)
...
func TestProgressReaderZeroTotal(t *testing.T) {
	...
	// total为0的情况（未知大小）
	pr := NewProgressReader(reader, 0, func(transferred, total int64, speed float64) {
		if total != 0 {
...
func TestFormatBytes2(t *testing.T) {
	tests := []struct {
		bytes    int64
		expected string
	}{
...
func TestFormatBits2(t *testing.T) {
	tests := []struct {
		bits     float64
		expected string
	}{
...
func TestFormatDuration2(t *testing.T) {
	tests := []struct {
		seconds  float64
		expected string
	}{
...
func TestFormatSpeed2(t *testing.T) {
	bytesPerSec := 1024.0
