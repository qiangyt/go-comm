...
func TestFileOps_FileExists2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_DirExists2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_GetFileSize2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_EnsureDir2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_CopyFile2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_MoveFile2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_RenameFile2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_CreateDirectory2(t *testing.T) {
	a := require.New(t)
...
func TestFileOps_RemoveFile2(t *testing.T) {
	a := require.New(t)
